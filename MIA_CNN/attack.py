...
def train_target_model(dataset, epochs=100, batch_size=100, learning_rate=0.01, l2_ratio=1e-7,
    ...
    output_layer = train_model(dataset, n_hidden=n_hidden, epochs=epochs, learning_rate=learning_rate,
                               batch_size=batch_size, model=model, l2_ratio=l2_ratio, noise =True)
...
def train_shadow_models(n_hidden=50, epochs=100, n_shadow=20, learning_rate=0.05, batch_size=100, l2_ratio=1e-7,
    ...
    input_var = T.tensor4('x')  #change it to tensor4 for CNN
    # for attack model
    attack_x, attack_y = [], []
    classes = []
    for i in range(n_shadow):
        ...
        print(train_x.shape)
        # train model
        output_layer = train_model1(data, n_hidden=n_hidden, epochs=epochs, learning_rate=learning_rate,
...
def train_attack_model(classes, dataset=None, n_hidden=50, learning_rate=0.01, batch_size=200, epochs=50,
    ...
    for c in unique_classes:
        ...
        c_pred_y = train_model1(c_dataset, n_hidden=n_hidden, epochs=epochs, learning_rate=learning_rate,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--shadow_epochs', type=int, default=200)
